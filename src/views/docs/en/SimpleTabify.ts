...
const SimpleTabifyPanel: DocPanel = {
  ...
  render(container: HTMLElement) {
    ...
    p1.textContent = 'SimpleTabify is a service for converting musical scores to standard formats, supporting multiple input and output formats, making it convenient for music creators and enthusiasts.';

...
export default {
	...
	render(container: HTMLElement, plugin?: MyPlugin) {
		...
		container.createEl('p', { text: '以下示例演示显示/隐藏力度标记、系统分隔符与调弦显示控制、轨名策略等。' });

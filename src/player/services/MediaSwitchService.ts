...
export class MediaSwitchService {
     ...
     * 切换到音频文件模式
     */
    private async switchToAudio(source: Extract<MediaSource, { type: MediaType.Audio }>): Promise<void> {
     ...
     * 切换到 YouTube 模式
     */
    private async switchToYouTube(source: Extract<MediaSource, { type: MediaType.YouTube }>): Promise<void> {
     ...
     * 切换到外部媒体模式
     */
    private async switchToExternal(source: Extract<MediaSource, { type: MediaType.External }>): Promise<void> {
